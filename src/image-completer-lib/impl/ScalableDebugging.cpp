...
namespace LfnIc
{
	...
	public:
		...
		virtual Pixel* GetRgb() { return reinterpret_cast<LfnIc::Image::Pixel*>(m_wxImage.GetData()); }
		virtual const Pixel* GetRgb() const { return reinterpret_cast<const LfnIc::Image::Pixel*>(m_wxImage.GetData()); }
